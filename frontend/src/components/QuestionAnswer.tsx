...
export default function QuestionAnswer({ data }: { data: QuestionAnswerType }) {
  const [
    expandedQuestion,
    setExpandedQuestion,
  ...
  return (
    <div className="max-w-[1464px] mx-auto block min-[900px]:flex gap-6 mb-14 min-[600px]:mb-28">
      <div className="min-[1464px]:ml-[211px] min-[1300px]:ml-[100px]">
        ...
        <div className="flex flex-col gap-8 px-11 relative before:content-[''] before:absolute before:-top-4 before:left-11 before:right-11 before:h-px before:bg-[rgba(196,_196,_196,_0.5)]">
          {data.QnAList.map((item, index) => (
              <div className="relative after:content-[''] after:absolute after:-bottom-4 after:left-[0] after:w-full after:h-px after:bg-[rgba(196,_196,_196,_0.5)]" key={item.title}>
                <button
                  type="button"
                  className={classNames(
                    'w-full qa-after-plus-icon flex justify-between text-[18px] text-byteex-blue',
                    { 'qa-after-minus-icon': expandedQuestion === index },
                  )}
      ...
      <Image
        className="hidden min-[900px]:block min-[1464px]:mr-[105px]  min-[1300px]:mr-[50px]"
